...
class Predictor():
    ...
    # def setup(self):
        ...
        self.models = blip_decoder(pretrained='https://storage.googleapis.com/sfr-vision-language-research/BLIP/models/model_base_capfilt_large.pth',
...
#     img=r"C:\Users\Aatif\Desktop\Bllip_for_Image_Captioning\New_BLip\download.png"

#     obj= Predictor()
    # rslt=obj.predict(img,task ,question=None, caption=None)
